...
Any Trello board that tracks feature/audit work with waiting → done style lists, in any language — list, label, and status names are matched in the board's own language.
...
- Normalizes card titles vs. audit titles/screenshot slugs (diacritics, punctuation, hyphens) to find safe matches; skips ambiguous matches rather than guessing.
